...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AtencionSalud'
        db.create_table('encuesta_atencionsalud', (
        ...
        db.send_create_signal('encuesta', ['AtencionSalud'])


    def backwards(self, orm):
        
        # Deleting model 'AtencionSalud'
        db.delete_table('encuesta_atencionsalud')

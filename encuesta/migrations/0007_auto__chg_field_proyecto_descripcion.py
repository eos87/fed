...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proyecto.descripcion'
        db.alter_column('encuesta_proyecto', 'descripcion', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Proyecto.descripcion'
        db.alter_column('encuesta_proyecto', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AtencionVictima.sevicio_legal'
        db.delete_column('encuesta_atencionvictima', 'sevicio_legal')

        # Adding field 'AtencionVictima.servicio_legal'
        db.add_column('encuesta_atencionvictima', 'servicio_legal', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AtencionVictima.sevicio_legal'
        db.add_column('encuesta_atencionvictima', 'sevicio_legal', self.gf('django.db.models.fields.IntegerField')(default=''), keep_default=False)

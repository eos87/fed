...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AtencionVictima.servicio_salud'
        db.delete_column('encuesta_atencionvictima', 'servicio_salud')

        # Deleting field 'AtencionVictima.servicio_salud_especial'
        db.delete_column('encuesta_atencionvictima', 'servicio_salud_especial')

        # Deleting field 'AtencionVictima.atencion_social'
        db.delete_column('encuesta_atencionvictima', 'atencion_social')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AtencionVictima.servicio_salud'
        db.add_column('encuesta_atencionvictima', 'servicio_salud', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AtencionVictima.servicio_salud_especial'
        db.add_column('encuesta_atencionvictima', 'servicio_salud_especial', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AtencionVictima.atencion_social'
        db.add_column('encuesta_atencionvictima', 'atencion_social', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

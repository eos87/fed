...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InvolucramientoPobMeta'
        db.create_table('encuesta_involucramientopobmeta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('accion', self.gf('django.db.models.fields.CharField')(default='no-responde', max_length=100, blank=True)),
            ('prev_vio', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('ssr', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('vih_sida', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('masculinidad', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('div_sexual', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('equidad', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ...
        db.send_create_signal('encuesta', ['InvolucramientoPobMeta'])


    def backwards(self, orm):
        
        # Deleting model 'InvolucramientoPobMeta'
        db.delete_table('encuesta_involucramientopobmeta')

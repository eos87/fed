...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EstadoCapacidadAdmitiva.sistema'
        db.alter_column('encuesta_estadocapacidadadmitiva', 'sistema', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'EstadoCapacidadAdmitiva.plan'
        db.alter_column('encuesta_estadocapacidadadmitiva', 'plan', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'EstadoCapacidadAdmitiva.organizaciones'
        db.alter_column('encuesta_estadocapacidadadmitiva', 'organizaciones', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        ...
        # Changing field 'AccionEfectuadaMedio.accion'
        db.alter_column('encuesta_accionefectuadamedio', 'accion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EstadoCapacidadAdmitiva.sistema'
        db.alter_column('encuesta_estadocapacidadadmitiva', 'sistema', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'EstadoCapacidadAdmitiva.plan'
        db.alter_column('encuesta_estadocapacidadadmitiva', 'plan', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'EstadoCapacidadAdmitiva.organizaciones'
        db.alter_column('encuesta_estadocapacidadadmitiva', 'organizaciones', self.gf('django.db.models.fields.CharField')(max_length=100))
        ...
        # Changing field 'AccionEfectuadaMedio.accion'
        db.alter_column('encuesta_accionefectuadamedio', 'accion', self.gf('django.db.models.fields.CharField')(max_length=100))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionEfectuadaDocumento.viol_aprob'
        db.add_column('encuesta_accionefectuadadocumento', 'viol_aprob', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaDocumento.ssr_aprob'
        db.add_column('encuesta_accionefectuadadocumento', 'ssr_aprob', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaDocumento.vih_aprob'
        db.add_column('encuesta_accionefectuadadocumento', 'vih_aprob', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaDocumento.masc_aprob'
        db.add_column('encuesta_accionefectuadadocumento', 'masc_aprob', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaDocumento.div_aprob'
        db.add_column('encuesta_accionefectuadadocumento', 'div_aprob', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccionEfectuadaDocumento.viol_aprob'
        db.delete_column('encuesta_accionefectuadadocumento', 'viol_aprob')

        # Deleting field 'AccionEfectuadaDocumento.ssr_aprob'
        db.delete_column('encuesta_accionefectuadadocumento', 'ssr_aprob')

        # Deleting field 'AccionEfectuadaDocumento.vih_aprob'
        db.delete_column('encuesta_accionefectuadadocumento', 'vih_aprob')

        # Deleting field 'AccionEfectuadaDocumento.masc_aprob'
        db.delete_column('encuesta_accionefectuadadocumento', 'masc_aprob')

        # Deleting field 'AccionEfectuadaDocumento.div_aprob'
        db.delete_column('encuesta_accionefectuadadocumento', 'div_aprob')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionEfectuadaMedio.viol_part'
        db.add_column('encuesta_accionefectuadamedio', 'viol_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.ssr_part'
        db.add_column('encuesta_accionefectuadamedio', 'ssr_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.vih_sida_part'
        db.add_column('encuesta_accionefectuadamedio', 'vih_sida_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.masc_part'
        db.add_column('encuesta_accionefectuadamedio', 'masc_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.div_sexual_part'
        db.add_column('encuesta_accionefectuadamedio', 'div_sexual_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccionEfectuadaMedio.viol_part'
        db.delete_column('encuesta_accionefectuadamedio', 'viol_part')

        # Deleting field 'AccionEfectuadaMedio.ssr_part'
        db.delete_column('encuesta_accionefectuadamedio', 'ssr_part')

        # Deleting field 'AccionEfectuadaMedio.vih_sida_part'
        db.delete_column('encuesta_accionefectuadamedio', 'vih_sida_part')

        # Deleting field 'AccionEfectuadaMedio.masc_part'
        db.delete_column('encuesta_accionefectuadamedio', 'masc_part')

        # Deleting field 'AccionEfectuadaMedio.div_sexual_part'
        db.delete_column('encuesta_accionefectuadamedio', 'div_sexual_part')

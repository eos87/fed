...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.user'
        db.add_column('encuesta_organizacion', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Proyecto.user'
        db.add_column('encuesta_proyecto', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.user'
        db.delete_column('encuesta_organizacion', 'user_id')

        # Deleting field 'Proyecto.user'
        db.delete_column('encuesta_proyecto', 'user_id')

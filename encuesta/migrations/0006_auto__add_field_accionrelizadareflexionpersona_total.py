...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionRelizadaReflexionPersona.total'
        db.add_column('encuesta_accionrelizadareflexionpersona', 'total', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccionRelizadaReflexionPersona.total'
        db.delete_column('encuesta_accionrelizadareflexionpersona', 'total')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionRealizadaReflexion.total'
        db.add_column('encuesta_accionrealizadareflexion', 'total', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccionRealizadaReflexion.total'
        db.delete_column('encuesta_accionrealizadareflexion', 'total')

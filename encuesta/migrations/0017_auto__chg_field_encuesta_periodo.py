...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Encuesta.periodo'
        db.alter_column('encuesta_encuesta', 'periodo', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Encuesta.periodo'
        db.alter_column('encuesta_encuesta', 'periodo', self.gf('django.db.models.fields.CharField')(max_length=100))

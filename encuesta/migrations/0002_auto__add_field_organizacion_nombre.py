...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.nombre'
        db.add_column('encuesta_organizacion', 'nombre', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.nombre'
        db.delete_column('encuesta_organizacion', 'nombre')

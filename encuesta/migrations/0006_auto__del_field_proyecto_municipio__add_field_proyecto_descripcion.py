...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('encuesta_proyecto', 'municipio')

        # Adding field 'Proyecto.descripcion'
        db.add_column('encuesta_proyecto', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Proyecto.municipio'
        db.add_column('encuesta_proyecto', 'municipio', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Proyecto.descripcion'
        db.delete_column('encuesta_proyecto', 'descripcion')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionEfectuadaRegion.viol_part'
        db.add_column('encuesta_accionefectuadaregion', 'viol_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaRegion.ssr_part'
        db.add_column('encuesta_accionefectuadaregion', 'ssr_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaRegion.vih_sida_part'
        db.add_column('encuesta_accionefectuadaregion', 'vih_sida_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaRegion.masc_part'
        db.add_column('encuesta_accionefectuadaregion', 'masc_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaRegion.div_sexual_part'
        db.add_column('encuesta_accionefectuadaregion', 'div_sexual_part', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccionEfectuadaRegion.viol_part'
        db.delete_column('encuesta_accionefectuadaregion', 'viol_part')

        # Deleting field 'AccionEfectuadaRegion.ssr_part'
        db.delete_column('encuesta_accionefectuadaregion', 'ssr_part')

        # Deleting field 'AccionEfectuadaRegion.vih_sida_part'
        db.delete_column('encuesta_accionefectuadaregion', 'vih_sida_part')

        # Deleting field 'AccionEfectuadaRegion.masc_part'
        db.delete_column('encuesta_accionefectuadaregion', 'masc_part')

        # Deleting field 'AccionEfectuadaRegion.div_sexual_part'
        db.delete_column('encuesta_accionefectuadaregion', 'div_sexual_part')

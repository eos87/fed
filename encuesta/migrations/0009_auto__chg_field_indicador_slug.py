...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicador.slug'
        db.alter_column('encuesta_indicador', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Indicador.slug'
        db.alter_column('encuesta_indicador', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field variables on 'Indicador'
        db.create_table('encuesta_indicador_variables', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('indicador', models.ForeignKey(orm['encuesta.indicador'], null=False)),
            ('contenttype', models.ForeignKey(orm['contenttypes.contenttype'], null=False))
        ))
        db.create_unique('encuesta_indicador_variables', ['indicador_id', 'contenttype_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field variables on 'Indicador'
        db.delete_table('encuesta_indicador_variables')
    ...
    models = {
        ...
        'encuesta.indicador': {
            ...
            'variables': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['contenttypes.ContentType']", 'symmetrical': 'False'})
        },

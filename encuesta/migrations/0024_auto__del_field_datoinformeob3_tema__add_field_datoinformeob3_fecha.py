...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DatoInformeOb3.tema'
        db.delete_column('encuesta_datoinformeob3', 'tema_id')

        # Adding field 'DatoInformeOb3.fecha'
        db.add_column('encuesta_datoinformeob3', 'fecha', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 1, 28, 15, 14, 53, 304841)), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DatoInformeOb3.tema'
        db.add_column('encuesta_datoinformeob3', 'tema', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['encuesta.Tema']), keep_default=False)

        # Deleting field 'DatoInformeOb3.fecha'
        db.delete_column('encuesta_datoinformeob3', 'fecha')
    ...
    models = {
        ...
        'encuesta.indicador': {
            'Meta': {'ordering': "['id']", 'object_name': 'Indicador'},

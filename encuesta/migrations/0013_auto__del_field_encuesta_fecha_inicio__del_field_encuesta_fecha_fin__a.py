...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Encuesta.fecha_inicio'
        db.delete_column('encuesta_encuesta', 'fecha_inicio')

        # Deleting field 'Encuesta.fecha_fin'
        db.delete_column('encuesta_encuesta', 'fecha_fin')

        # Adding field 'Encuesta.periodo'
        db.add_column('encuesta_encuesta', 'periodo', self.gf('django.db.models.fields.CharField')(default='-', max_length=100), keep_default=False)

        # Adding field 'Encuesta.anio'
        db.add_column('encuesta_encuesta', 'anio', self.gf('django.db.models.fields.CharField')(default='-', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Encuesta.fecha_inicio'
        db.add_column('encuesta_encuesta', 'fecha_inicio', self.gf('django.db.models.fields.DateField')(default=''), keep_default=False)

        # Adding field 'Encuesta.fecha_fin'
        db.add_column('encuesta_encuesta', 'fecha_fin', self.gf('django.db.models.fields.DateField')(default=''), keep_default=False)

        # Deleting field 'Encuesta.periodo'
        db.delete_column('encuesta_encuesta', 'periodo')

        # Deleting field 'Encuesta.anio'
        db.delete_column('encuesta_encuesta', 'anio')
    ...
    models = {
        ...
        'encuesta.encuesta': {
            ...
            'periodo': ('django.db.models.fields.CharField', [], {'max_length': '100'}),

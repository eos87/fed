...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.tipo'
        db.add_column('encuesta_organizacion', 'tipo', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.tipo'
        db.delete_column('encuesta_organizacion', 'tipo')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.sistema'
        db.add_column('encuesta_organizacion', 'sistema', self.gf('django.db.models.fields.CharField')(default='no-responde', max_length=100, blank=True), keep_default=False)

        # Adding field 'Organizacion.plan'
        db.add_column('encuesta_organizacion', 'plan', self.gf('django.db.models.fields.CharField')(default='no-responde', max_length=100, blank=True), keep_default=False)

        # Adding field 'Organizacion.organizaciones'
        db.add_column('encuesta_organizacion', 'organizaciones', self.gf('django.db.models.fields.CharField')(default='no-responde', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.sistema'
        db.delete_column('encuesta_organizacion', 'sistema')

        # Deleting field 'Organizacion.plan'
        db.delete_column('encuesta_organizacion', 'plan')

        # Deleting field 'Organizacion.organizaciones'
        db.delete_column('encuesta_organizacion', 'organizaciones')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meta.slug'
        db.add_column('encuesta_meta', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meta.slug'
        db.delete_column('encuesta_meta', 'slug')

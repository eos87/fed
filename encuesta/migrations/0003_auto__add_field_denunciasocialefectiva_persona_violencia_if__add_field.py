...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DenunciaSocialEfectiva.persona_violencia_if'
        db.add_column('encuesta_denunciasocialefectiva', 'persona_violencia_if', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DenunciaSocialEfectiva.persona_violencia_if'
        db.delete_column('encuesta_denunciasocialefectiva', 'persona_violencia_if')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccionEfectuadaMedio.ssr'
        db.add_column('encuesta_accionefectuadamedio', 'ssr', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.vih_sida'
        db.add_column('encuesta_accionefectuadamedio', 'vih_sida', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.masculinidad'
        db.add_column('encuesta_accionefectuadamedio', 'masculinidad', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.div_sexual'
        db.add_column('encuesta_accionefectuadamedio', 'div_sexual', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'AccionEfectuadaMedio.equidad'
        db.add_column('encuesta_accionefectuadamedio', 'equidad', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccionEfectuadaMedio.ssr'
        db.delete_column('encuesta_accionefectuadamedio', 'ssr')

        # Deleting field 'AccionEfectuadaMedio.vih_sida'
        db.delete_column('encuesta_accionefectuadamedio', 'vih_sida')

        # Deleting field 'AccionEfectuadaMedio.masculinidad'
        db.delete_column('encuesta_accionefectuadamedio', 'masculinidad')

        # Deleting field 'AccionEfectuadaMedio.div_sexual'
        db.delete_column('encuesta_accionefectuadamedio', 'div_sexual')

        # Deleting field 'AccionEfectuadaMedio.equidad'
        db.delete_column('encuesta_accionefectuadamedio', 'equidad')
